...
export function ChapterInteractive({
  ...
  useEffect(() => {
    if (!activeExperimentId && defaultExperiment) {
      setSelectedExperimentId(defaultExperiment);
    } else if (activeExperimentId) {
      setSelectedExperimentId(activeExperimentId);
    }
  }, [activeExperimentId, defaultExperiment]);
    ...
    <section className="mx-auto flex max-w-6xl flex-col gap-5 px-6 pb-12 sm:pb-16">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <h3 className="mt-2 text-2xl font-semibold text-slate-950 font-[family:var(--font-display)]">
