...
describe("v1-ch01-s03 calibration", () => {
  it("raises dissolution with higher temperature", () => {
    ...
    expect(metricValue(hot, "salt")).toBeGreaterThan(metricValue(cold, "salt"));
  });
  ...
  it("increases condensation with higher humidity", () => {
    ...
    expect(metricValue(wet, "cond")).toBeGreaterThan(metricValue(dry, "cond"));
  });
});
